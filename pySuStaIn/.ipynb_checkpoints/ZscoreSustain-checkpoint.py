...
class ZscoreSustain(AbstractSustain):
    ...
    def __init__(self,
        ...
        # In Kiwamu's work they're only choosing positive z-scores
        IX_select               = stage_zscore>0
        
        # In Robin's Project we are allowing negative z-scores
        # IX_select               = [True for n in stage_zscore]
        #IX = np.array([True for n in stage_zscore[0]])
        ...
        # Kiwamu's model does not allow for negative z-scores
        self.min_biomarker_zscore       = [0] * N
        self.max_biomarker_zscore       = Z_max
        self.std_biomarker_zscore       = [1] * N

        # Robin's project allows for negative z-scores
        #self.min_biomarker_zscore       = [-4] * N
        #self.max_biomarker_zscore       = Z_max
        #self.std_biomarker_zscore       = [1] * N
